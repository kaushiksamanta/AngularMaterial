 ...
 */
App.controller('pastController', ['$scope', '$http','Api','$state','$timeout','$cookieStore','$mdDialog','$mdMedia','$loading','$rootScope',
    function($scope,$http,Api,$state,$timeout,$cookieStore,$mdDialog,$mdMedia,$loading,$rootScope) {
        ...
        angular.element(document).ready(function(){
            angular.element('#pastPage').css('min-height', angular.element(window).height() -55 - 60+'px');
        ...
        $scope.getbookings = function(){
            $http({
                url: Api.url + '/api/partner/bookings?type=COMPLETED',
                method: "GET",
                headers: {
